...
def config():
    ...
    parser.add_argument('--n_bits_teacher', default=4, type=int, metavar='N',
                        help='None')
    
    parser.add_argument('--acti_n_bits_teacher', default=4, type=int, metavar='N',
                        help='None')
    
    parser.add_argument('--layers_teacher', default=32, type=int, metavar='N',
                        help='None')

    parser.add_argument('--kd_phase', default='full', type=str,
                        help='None')
    
    parser.add_argument('--teacher_full', default='no', type=str,
                        help='None')
    
    parser.add_argument('--t', default=3, type=float, help='None')

    parser.add_argument('--alpha', default=0.5, type=float, help='None')

    parser.add_argument('--beta', default=1.5, type=float, help='None')

    parser.add_argument('--kd_method', default='kd', type=str, help='None')

    parser.add_argument('--trial_num', default=0, type=int, help='None')
